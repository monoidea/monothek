...
#define AGS_IS_XORG_SESSION_MANAGER(obj)             (G_TYPE_CHECK_INSTANCE_TYPE ((obj), MONOTHEK_TYPE_SESSION_MANAGER))
#define AGS_IS_XORG_SESSION_MANAGER_CLASS(class)     (G_TYPE_CHECK_CLASS_TYPE ((class), MONOTHEK_TYPE_SESSION_MANAGER))
