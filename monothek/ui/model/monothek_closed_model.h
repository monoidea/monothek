...
#ifndef __MONOTHEK_CLOSED_MODEL_H__
#define __MONOTHEK_CLOSED_MODEL_H__
...
typedef struct _MonothekClosedModel MonothekClosedModel;
typedef struct _MonothekClosedModelClass MonothekClosedModelClass;
...
GType monothek_closed_model_get_type(void);

MonothekClosedModel* monothek_closed_model_new();

#endif /*__MONOTHEK_CLOSED_MODEL_H__*/
