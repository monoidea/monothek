...
void monothek_diskjokey_end_view_reset(MonothekView *view,
				       gboolean reset_defaults, gboolean reset_current);
void monothek_diskjokey_end_view_clear(MonothekView *view,
...
monothek_diskjokey_end_view_class_init(MonothekDiskjokeyEndViewClass *diskjokey_end_view)
{
  ...
  view->reset = monothek_diskjokey_end_view_reset;
  view->clear = monothek_diskjokey_end_view_clear;
}
...
void
monothek_diskjokey_end_view_reset(MonothekView *view,
				  gboolean reset_defaults, gboolean reset_current)
{
  //TODO:JK: implement me
}
...
void
monothek_diskjokey_end_view_clear(MonothekView *view,
				  gboolean clear_all, gboolean clear_hover)
{
  MonothekDiskjokeyEndModel *diskjokey_end_model;
