...
#ifndef __MONOTHEK_DISKJOKEY_END_VIEW_H__
#define __MONOTHEK_DISKJOKEY_END_VIEW_H__
...
typedef struct _MonothekDiskjokeyEndView MonothekDiskjokeyEndView;
typedef struct _MonothekDiskjokeyEndViewClass MonothekDiskjokeyEndViewClass;
...
GType monothek_diskjokey_end_view_get_type(void);

MonothekDiskjokeyEndView* monothek_diskjokey_end_view_new();

#endif /*__MONOTHEK_DISKJOKEY_END_VIEW_H__*/
