...
#ifndef __MONOTHEK_TRANSACTION_FAILED_VIEW_H__
#define __MONOTHEK_TRANSACTION_FAILED_VIEW_H__
...
typedef struct _MonothekTransactionFailedView MonothekTransactionFailedView;
typedef struct _MonothekTransactionFailedViewClass MonothekTransactionFailedViewClass;
...
GType monothek_transaction_failed_view_get_type(void);

MonothekTransactionFailedView* monothek_transaction_failed_view_new();

#endif /*__MONOTHEK_TRANSACTION_FAILED_VIEW_H__*/
