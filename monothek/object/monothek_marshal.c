...
void
monothek_cclosure_marshal_VOID__BOOLEAN_BOOLEAN (GClosure     *closure,
...
void
monothek_cclosure_marshal_VOID__ULONG_ULONG (GClosure     *closure,
                                             GValue       *return_value G_GNUC_UNUSED,
                                             guint         n_param_values,
                                             const GValue *param_values,
                                             gpointer      invocation_hint G_GNUC_UNUSED,
                                             gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__ULONG_ULONG) (gpointer data1,
                                                  gulong arg1,
                                                  gulong arg2,
                                                  gpointer data2);
  GCClosure *cc = (GCClosure *) closure;
  gpointer data1, data2;
  GMarshalFunc_VOID__ULONG_ULONG callback;
  ...
  callback = (GMarshalFunc_VOID__ULONG_ULONG) (marshal_data ? marshal_data : cc->callback);
...
void
monothek_cclosure_marshal_BOOLEAN__DOUBLE (GClosure     *closure,
                                           GValue       *return_value,
                                           guint         n_param_values,
                                           const GValue *param_values,
                                           gpointer      invocation_hint G_GNUC_UNUSED,
